...
In my free time, you'll find me engrossed in a game of online chess, running long distances with a History podcast, or curled up in a corner with a book.
...
The design of this website is <span class="strikethrough">copied from</span> heavily inspired by Ivan Echeverria's [website](https://www.echevarria.io/about). Credits to [Richard Rutter](https://clagnut.com/) and [Utopia](https://utopia.fyi/) for the fluid typography. The website's source is [public](https://github.com/anupamck/anupam.de).

You can read about how this website got started [here](/writing/essays/howThisSiteWasBorn.html). The good photographs on the site are my wife, Malavika's work (I am solely to blame for the bad ones).